...
const roleColors = {
    Admin: "bg-purple-800 text-purple-100",
    Customer: "bg-blue-800 text-blue-100",
    Moderator: "bg-yellow-800 text-yellow-100",
};
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                    <span
                                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                            roleColors[user.role] || "bg-gray-800 text-gray-100"
                                        }`}
                                    >
                                        {user.role}
                                    </span>
